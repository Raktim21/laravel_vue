            ...
            <div class="row">
                        ...
                        <div class="box-body pt-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="icon bg-primary-light rounded-circle">
                                    <i class="text-primary me-0 fs-20 fa fa-heartbeat"></i>
                                </div>
                                <div>
                                    <h3 class="text-dark mb-0 fw-500">4,235</h3>
                        ...
                        <div class="box-body pt-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="icon bg-info-light rounded-circle">
                                    <i class="text-info me-0 fs-20 fa fa-user-md"></i>
                                </div>
                                <div>
                                    <h3 class="text-dark mb-0 fw-500">394</h3>
                        ...
                        <div class="box-body pt-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="icon bg-warning-light rounded-circle">
                                    <i class="text-warning me-0 fs-20 fa fa-money"></i>
                                </div>
                                <div>
                                    <h3 class="text-dark mb-0 fw-500">$2,526</h3>
                        ...
                        <div class="box-body pt-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="icon bg-danger-light rounded-circle">
                                    <i class="text-danger me-0 fs-20 fa fa-ambulance"></i>
                                </div>
                                <div>
                                    <h3 class="text-dark mb-0 fw-500">35</h3>
                ...
                <div class="col-xl-7 col-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <li class="dropdown">
                                <button class="btn btn-rounded btn-outline btn-primary dropdown-toggle px-10 " data-bs-toggle="dropdown" href="#">Show By Months</button>
                                <div class="dropdown-menu">
                                <a class="dropdown-item" href="#"><i class="ti-import"></i> Import</a>
                                <a class="dropdown-item" href="#"><i class="ti-export"></i> Export</a>
                                <a class="dropdown-item" href="#"><i class="ti-printer"></i> Print</a>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-12">
                                    ...
                                    <h4 class="text-center">Bed Availability</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="d-flex align-items-center justify-content-between pb-10 pe-20">
                                <h5 class="my-0 text-light"><i class="fa fa-home me-50 w-20"></i>Division</h5>
                                <p class="mb-0 text-light">PT.</p>
                            </div>
                            <div class="pat-div">								
                                <div class="d-flex align-items-center justify-content-between my-15 pe-20">
                                    <h5 class="my-0"><i class="me-50 w-20 fa fa-heart"></i>Cardiology</h5>
                                    <p class="mb-0">74</p>
                                </div>								
                                <div class="d-flex align-items-center justify-content-between my-15 pe-20">
                                    <h5 class="my-0"><i class="me-50 w-20 fa fa-user"></i>Neurology</h5>
                                    <p class="mb-0">32</p>
                                </div>								
                                <div class="d-flex align-items-center justify-content-between my-15 pe-20">
                                    <h5 class="my-0"><i class="me-50 w-20 fa fa-user-md"></i>Surgery</h5>
                                    <p class="mb-0">15</p>
                                </div>							
                                <div class="d-flex align-items-center justify-content-between my-15 pe-20">
                                    <h5 class="my-0"><i class="me-50 w-20 fa fa-medkit"></i>Covid</h5>
                                    <p class="mb-0">35</p>
                                </div>							
                                <div class="d-flex align-items-center justify-content-between my-15 pe-20">
                                    <h5 class="my-0"><i class="me-50 w-20 fa fa-stethoscope"></i>General</h5>
                                    <p class="mb-0">158</p>
                                </div>							
                                <div class="d-flex align-items-center justify-content-between my-15 pe-20">
                                    <h5 class="my-0"><i class="me-50 w-20 fa fa-plus-square"></i>Oncology</h5>
                                    <p class="mb-0">85</p>
                                </div>							
                                <div class="d-flex align-items-center justify-content-between my-15 pe-20">
                                    <h5 class="my-0"><i class="me-50 w-20 fa fa-wheelchair-alt"></i>Emergency</h5>
                                    <p class="mb-0">45</p>
                                </div>
                            </div>
                        </div>
